    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-xl border-b border-purple-100/50">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <Image src={"/logo.png"} width={1536} height={1024} alt="Logo" className="md:max-w-[4rem] max-w-[3rem] h-auto" />
            <span className="font-serif font-bold md:text-2xl text-xl text-slate-900">MediChat</span>
          </div>
